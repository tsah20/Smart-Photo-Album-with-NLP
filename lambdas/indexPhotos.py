...
def lambda_handler(event, context):
    ...
    if image_name=="test.mp3" or image_name=="test.txt":
        return {
        'statusCode': 200,
    ...
    host = 'vpc-photos-tehaikmmz7dmfwpc2i2tgowvn4.us-east-1.es.amazonaws.com'
    ...
    res = es.index(index="photos", body=es_entry)
    print(res)

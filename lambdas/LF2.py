...
def clearIndices():
    host = 'https://vpc-photos2-sddcn5ldtjc3nh3ohvzojacdtm.us-east-1.es.amazonaws.com/photos2/'
    res = requests.delete(host)
    res = json.loads(res.content.decode('utf-8'))
    return res   

def searchIndices():
    host = 'https://vpc-photos2-sddcn5ldtjc3nh3ohvzojacdtm.us-east-1.es.amazonaws.com/photos2/_search?q=dog'
...
def searchElasticIndex(search):
    photos = []
    for s in search:
        host = 'https://vpc-photos2-sddcn5ldtjc3nh3ohvzojacdtm.us-east-1.es.amazonaws.com/photos2/_search?q='+s
        res = requests.get(host)
        res = json.loads(res.content.decode('utf-8'))
